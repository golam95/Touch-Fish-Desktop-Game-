...
import touchfishlavel3.ControlLavel4;

public class GameLavel3 {
	Font font1 = new Font("monospaced", Font.BOLD, 28);
	Font fontk = new Font("monospaced", Font.BOLD, 18);
	...
	@SuppressWarnings("unused")
	private Font font;
	private ArrayList<FishLavel3> ducks;
	...
	public GameLavel3() {
		ControlLavel3.gameState = ControlLavel3.GameState.GAME_CONTENT_LOADING;
		...
		Thread threadForInitGame = new Thread() {
			...
			public void run() {
				...
				ControlLavel3.gameState = ControlLavel3.GameState.PLAYING;
			}
		};
	...
	private void Initialize() {
		...
		ducks = new ArrayList<FishLavel3>();
		...
		timeBetweenShots = ControlLavel3.secInNanosec / 3;
		killedDucks = 0;
		...
		click_touch = 0;
		lastTime_touch = 0;
		timebettween_touch = ControlLavel3.secInNanosec / 3;

	}

	private void LoadContent() {
		try {
			URL backgroundImgUrl = this.getClass().getResource("/touchfishlavel2/resources/background.jpg");
			backgroundImg = ImageIO.read(backgroundImgUrl);

			URL grassImgUrl = this.getClass().getResource("/touchfishlavel2/resources/grass.png");
			grassImg = ImageIO.read(grassImgUrl);

			URL duckImgUrl = this.getClass().getResource("/touchfishlavel2/resources/dan.png");
			duckImg = ImageIO.read(duckImgUrl);

			URL duckImgUrl_sager = this.getClass().getResource("/touchfishlavel2/resources/octo.png");
			danImg = ImageIO.read(duckImgUrl_sager);

			URL duckImgUrl_enemytwo = this.getClass().getResource("/touchfishlavel2/resources/cakra.png");
			ememyImg = ImageIO.read(duckImgUrl_enemytwo);

			URL duckImgUrl_lifelavel3 = this.getClass().getResource("/touchfishlavel2/resources/life.png");
			lifelavel3Img = ImageIO.read(duckImgUrl_lifelavel3);

			URL sightImgUrl = this.getClass().getResource("/touchfishlavel2/resources/sight.png");
			sightImg = ImageIO.read(sightImgUrl);
			sightImgMiddleWidth = sightImg.getWidth() / 2;
			sightImgMiddleHeight = sightImg.getHeight() / 2;
		} catch (IOException ex) {
			Logger.getLogger(GameLavel3.class.getName()).log(Level.SEVERE, null, ex);
		}
	}
	...
	public void UpdateGame(long gameTime, Point mousePosition) {
		...
		if (System.nanoTime() - FishLavel3.lastDuckTime >= FishLavel3.timeBetweenDucks) {

			// Here we create new duck and add it to the array list.
			ducks.add(new FishLavel3(FishLavel3.duckLines[FishLavel3.nextDuckLines][0] + random.nextInt(200),
					FishLavel3.duckLines[FishLavel3.nextDuckLines][1], FishLavel3.duckLines[FishLavel3.nextDuckLines][2],
					FishLavel3.duckLines[FishLavel3.nextDuckLines][3], duckImg));
			...
			FishLavel3.nextDuckLines++;
			EnemyTwo.nextenemytwoLines++;
			Dangerous.nextdangerous++;
			if (FishLavel3.nextDuckLines >= FishLavel3.duckLines.length)
				FishLavel3.nextDuckLines = 0;
			FishLavel3.lastDuckTime = System.nanoTime();
			...
			for (int sager = 0; sager < dan.size(); sager++) {
				...
				if (player1.intersects(player2)) {
					...
					if (totalcounter == 5) {
						...
						ControlLavel3.gameState = ControlLavel3.GameState.GAMEOVER;
						break;
		...
		if (ActionLavel3.mouseButtonState(MouseEvent.BUTTON1)) {
		...
		if (killedDucks == 6) {
			...
			ControlLavel3.gameState = ControlLavel3.GameState.DESTROYED;

		}
	}

	public void Draw(Graphics2D g2d, Point mousePosition) {
		g2d.drawImage(backgroundImg, 0, 0, ControlLavel3.frameWidth, ControlLavel3.frameHeight, null);
		...
		g2d.drawImage(grassImg, 0, ControlLavel3.frameHeight - grassImg.getHeight(), ControlLavel3.frameWidth,
		...
		g2d.drawString("Touch Fish: " + killedDucks, 200, 21);
		g2d.drawString("Trying Touch Fish: " + shoots, 310, 21);
		g2d.drawString("Need Touch Fish: " + needtouchfish, 580, 21);
		g2d.drawString("SCORE: " + score, 800, 21);
		g2d.drawString("Life: " + life, 940, 21);
	...
	public void DrawGameOver(Graphics2D g2d, Point mousePosition) {
		...
		g2d.setFont(font1);
		g2d.drawString("You Lose !!!!", ControlLavel3.frameWidth / 2 - 39, (int) (ControlLavel3.frameHeight * 0.65) + 1);
		g2d.drawString("Press space for Retry or Press Home To Go MainMenu.", ControlLavel3.frameWidth / 2 - 249,
				(int) (ControlLavel3.frameHeight * 0.70) + 1);
	...
	public void DrawGameWin(Graphics2D g2d, Point mousePosition) {
		...
		g2d.setFont(font1);
		g2d.setColor(Color.RED);
		g2d.drawString("You Won This Level", ControlLavel3.frameWidth / 2 - 39, (int) (ControlLavel3.frameHeight * 0.65) + 1);
		g2d.drawString("Press P To Continue or Press Home Return MainMenu.", ControlLavel3.frameWidth / 2 - 249,
				(int) (ControlLavel3.frameHeight * 0.70) + 1);
