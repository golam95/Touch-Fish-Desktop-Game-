...
public class ControlLavel4 extends ActionLavel4 {
	...
	// The actual game
	private GameLavel4 game;

	private BufferedImage shootTheDuckMenuImg;

	public ControlLavel4() {
		super();
	...
	private void LoadContent() {
		try {
			URL shootTheDuckMenuImgUrl = this.getClass().getResource("/touchfishlavel3/resources/menu.jpg");
			shootTheDuckMenuImg = ImageIO.read(shootTheDuckMenuImgUrl);
		} catch (IOException ex) {
			Logger.getLogger(ControlLavel4.class.getName()).log(Level.SEVERE, null, ex);
		}
	}
	...
	public void Draw(Graphics2D g2d) {
		...
		case MAIN_MENU:
			...
			g2d.drawString("Lavel 4", ControlLavel4.frameWidth / 2 - 59, (int) (ControlLavel4.frameHeight * 0.63) + 1);
			g2d.setFont(font);
			g2d.setColor(Color.black);
	...
	public void keyReleasedFramework(KeyEvent e) {
		...
		case GAMEOVER:
			if (e.getKeyCode() == KeyEvent.VK_HOME) {
				...
				ShowTitlePagefour.destroytitlepage_four();
